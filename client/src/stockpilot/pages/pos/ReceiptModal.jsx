    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4" style={{ background: "rgba(15,23,42,0.5)" }}>
      <div className="w-full max-w-xs rounded-2xl p-5 font-mono" style={{ background: t.card }}>
        <div className="text-center mb-3">
          <PackageCheck size={28} style={{ color: t.success }} className="mx-auto mb-1" />
          <p className="text-sm font-bold" style={{ color: t.text }}>Sale Complete</p>
        ...
        <div className="border-t border-dashed mt-2 pt-2 text-[11px] space-y-1" style={{ borderColor: t.border }}>
          ...
          <div className="flex justify-between" style={{ color: t.sub }}><span>Tax</span><span>{money(tax)}</span></div>
